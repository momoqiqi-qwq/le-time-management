...
(function(){
 ...
 .sg .style-preview-grid .demo{border-radius:var(--sg-course-radius,8px);border:1px solid color-mix(in srgb,var(--course-accent) 35%,var(--sg-line));border-left:3px solid var(--course-accent);background:var(--course-bg);padding:7px 8px;color:var(--sg-ink);opacity:var(--sg-course-opacity,1);min-height:64px}
 ...
 :is(.sg.colorful,.style-preview.colorful) .tone-0{--course-accent:#2563eb;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-1{--course-accent:#0f766e;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-2{--course-accent:#b45309;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-3{--course-accent:#7c3aed;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-4{--course-accent:#c0392b;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-5{--course-accent:#0e7490;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-6{--course-accent:#15803d;--course-on:#fff}
 :is(.sg.colorful,.style-preview.colorful) .tone-7{--course-accent:#4338ca;--course-on:#fff}
