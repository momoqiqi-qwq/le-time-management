...
(function(){
 ...
 @media(max-width:620px){.sg .hero-copy h2{font-size:19px}.sg .hero-copy .muted{font-size:11px}.sg .schedule-grid{grid-template-columns:54px repeat(7,70px);min-width:544px}.sg .slot-label b{font-size:15px}.sg .slot-label span{font-size:8.8px}.sg .day-head{font-size:12px}.sg .course-block{padding:5px 4px}.sg .course-block b{font-size:11px;-webkit-line-clamp:4}.sg .course-block span{font-size:9px}.sg .week-title{min-height:36px;padding:2px 4px}.sg .week-title b{font-size:18px}.sg .actionbar{justify-content:flex-start;overflow-x:auto;flex-wrap:nowrap;padding-bottom:2px}.sg .actionbar button{white-space:nowrap}.sg .fields{grid-template-columns:1fr}.sg .form,.sg .panel{padding:13px}}
