...
const plugins = [
  ...
  },
  {
    ...
    "name": "警大门户通知",
    "version": "1.25.0",
    "author": "基于 dsh-user/cppu-notify-skill v1.2.1 · U-Time适配（1.25.0 教务页面自带自动登录）",
    "icon": "building-columns",
    "faIcon": "building-columns",
    "description": "智慧警大门户通知：登录一次后全程自动登录——优先恢复门户票据，主 SSO 有效时自动补全 bridge 链路，票据过期则自动识别验证码完成登录。左侧「校园服务」栏提供 WebVPN、教育邮箱、教务、学工、我的请假、一网通办、一卡通等入口，其中「教务」是带子菜单的父项：整行仍然免密换票打开教务首页，右侧箭头展开后直达学生选课、学生请假、警大学分和创新学分四个页面。这四个页面均为 U-Time 自有页面，且和通知页共用同一份登录代码：直接点进来就会自动恢复会话、自动换票建立教务登录态，认不出验证码时才在页面内摆出登录卡，不必先绕去警大通知手工登录。选课任务显示状态并将过期任务置灰；警大学分组合培养计划与课程成绩，按必修、选修、实践显示目标、已获学分和课程明细，可隐藏已修完课程；创新学分按学期显示真实申报项目、级别、奖项、认定学分与审核状态。教务写操作最终仍回学校系统确认。「教育邮箱」复用加密保存的警大密码自动登录；「一卡通」使用独立 OAuth 自动登录并读取平台流水，显示总充值、已花费和实时余额（校园卡账户与电子账户合并计算），并可按年、月、日切换查看充值或消费统计。通知支持每 10 分钟自动刷新、考试/比赛/通知分类、正文阅读、附件显示与应用内下载、转为提醒及微信推送联动。",
    "permissions": [
      "ui",
      "tasks",
      "blocks",
